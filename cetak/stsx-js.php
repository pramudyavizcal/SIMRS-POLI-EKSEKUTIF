...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-none pt-0 pb-0" id="bodyTagihanPasien">

                            <div id="TagihanPasien"></div>
                            <!-- <div id="TagihanFarmasi"></div>
                            <div id="totalTagihan"></div> -->
                        </div>
                        <div class="card-body d-none pt-0 pb-0" id="bodyTombolBayar">
    ...
    <script>
        ...
        function tampilkanBiodata(data) {
            ...
            $("#headerCariPasien").addClass("d-none");
            var biodata = "";
            if (data["noRM"] != "") {
        ...
        function tampilkanTagihan(data) {
            ...
            if (jumlah > 0) {
                ...
                if (nKodeMutasiPasien == null) {
                    ...
                    tombol += "<button type='button' class='btn btn-danger' id='submitTunai' onclick='submitTunai(`" + user + "`," + nKodeMutasiPasien + ",`" + caraBayar + "`," + episode + "," + nKodePoli + "," + total + "," + tahunSekarang + ")'> Tunai </button> &nbsp;&nbsp;";
                    tombol += "<button type='button' class='btn btn-success' id='submitEDC'> Non Tunai </button>";
                    tombol += "</div>"
        ...
        function submitTunai(n, nKodeMutasiPasien, szBayar, nEpisode, nKodePoli, curBayar, tahunSekarang) {
            $.get('bayarInputEksekutif.php?Tunai=true&n=' + n +
                '&nKodeMutasiPasien=' + nKodeMutasiPasien + '&szBayar=' + szBayar +
